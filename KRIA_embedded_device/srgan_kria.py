...
class Generator(nn.Module):
    ...
    def __init__(self, img_feat = 3, n_feats = 64, kernel_size = 3, num_block = 16, act =nn.LeakyReLU(0.01), scale=4):
        ...
        self.last_conv = conv(in_channel = n_feats, out_channel = img_feat, kernel_size = 3, BN = False, act = nn.LeakyReLU(0.01))
